...
// Outro content.
$name = 'cdelement_outro/outro_content';
...
$options = [
    ...
    outro::OUTRO_BUTTON_FINISHATTEMPT => get_string('outro:btnfinishattempt', 'mod_contentdesigner'),
];
$name = 'cdelement_outro/primarybutton';
...
$name = 'cdelement_outro/secondarybutton';
