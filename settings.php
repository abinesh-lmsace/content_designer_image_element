...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('mod_contentdesigner/navigation',
    get_string('navigation', 'mod_contentdesigner'), get_string('navigation_help', 'mod_contentdesigner'),
    CONTENTDESIGNER_NAVIGATION_SEQUENTIAL, $options));
